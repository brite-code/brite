...
import {ScalarType, Type} from './type';
...
export namespace Expression {
  ...
  export namespace Typed {
    ...
    export function boolean(value: boolean): Expression<never, ScalarType> {
      return {
        type: Type.boolean,
        description: {kind: 'Constant', constant: {kind: 'Boolean', value}},
      };
    ...
    export function number(value: number): Expression<never, ScalarType> {
      return {
        type: Type.number,
        description: {kind: 'Constant', constant: {kind: 'Number', value}},
      };
    ...
    export function string(value: string): Expression<never, ScalarType> {
      return {
        type: Type.string,
        description: {kind: 'Constant', constant: {kind: 'String', value}},
      };
    ...
    export function function_<Diagnostic = never, Type = never>(
      type: Type,
      parameter: string,
    ...
    export function call<Diagnostic = never, Type = never>(
      type: Type,
    ...
    export function binding<Diagnostic = never, Type = never>(
      binding: string,
    ...
    export function error<Diagnostic, Type>(
      type: Type,
      error: Reported<Diagnostic>
    ): Expression<Diagnostic, Type> {
      return {
