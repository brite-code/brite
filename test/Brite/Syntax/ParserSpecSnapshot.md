...
### AST
```
(bind (var 0:4-0:5 f) (err (fun 0:8-0:18 (block 0:16-0:18))))
```
...
(bind
  (var 0:4-0:5 f)
  (err (fun 0:8-0:19 (param (var 0:14-0:15 a)) (block 0:17-0:19))))
```
...
(bind
  (var 0:4-0:5 f)
  (err (fun 0:8-0:20 (param (var 0:14-0:15 a)) (block 0:18-0:20))))
```
