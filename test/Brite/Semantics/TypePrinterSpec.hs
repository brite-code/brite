...
testData =
  ...
  , ("<T = {a: Bool}> {b: Int | T}", "{a: Bool, b: Int}")
  , ("<T = {b: Bool}> {a: Int | T}", "{b: Bool, a: Int}")
  , ("<T = {a: Bool}> {a: Int | T}", "{a: Int, a: Bool}")
  , ("<T = {a: Bool}> {a: Int, b: void | T}", "{a: Int, a: Bool, b: void}")
  , ("<T = {a: Bool}> {b: void, a: Int | T}", "{a: Int, a: Bool, b: void}")
  , ("<T = {a: Bool, b: void}> {a: Int | T}", "{a: Int, a: Bool, b: void}")
  , ("<T = {b: void, a: Bool}> {a: Int | T}", "{b: void, a: Int, a: Bool}")
  ...
  , ("<T: <T> {a: T}> {b: Int | T}", "{a: Bool, b: Int}")
  , ("<T: <T> {b: T}> {a: Int | T}", "{b: Bool, a: Int}")
  , ("<T: <T> {a: T}> {a: Int | T}", "{a: Int, a: Bool}")
  , ("<T: <T> {a: T}> {a: Int, b: void | T}", "{a: Int, a: Bool, b: void}")
  , ("<T: <T> {a: T}> {b: void, a: Int | T}", "{a: Int, a: Bool, b: void}")
  , ("<T: <T> {a: T, b: void}> {a: Int | T}", "{a: Int, a: Bool, b: void}")
  , ("<T: <T> {b: void, a: T}> {a: Int | T}", "{b: void, a: Int, a: Bool}")
  , ("<T: <T> {a: T, a: void}> {a: Int | T}", "{a: Int, a: Bool, a: void}")
  , ("<T: <T> {a: T}> {a: Int, a: Bool, | T}", "{a: Int, a: Bool, a: void}")
  , ("<U: <T> {a: T}, T = {a: Bool | U}> {a: Int | T}", "{a: Int, a: Bool, a: void}")
  , ("<U = {a: void}, T: <T> {a: T | U}> {a: Int | T}", "{a: Int, a: Bool, a: void}")
  , ("<U: <T> {a: T}, T: <T> {a: T | U}> {a: Int | T}", "{a: Int, a: Bool, a: void}")
  , ("<T: <T> {a: T, a: T}> {a: Int | T}", "{a: Int, a: Bool, a: void}")
  , ("<T: <T> {b: T, a: T}> {a: Int | T}", "{b: void, a: Int, a: Bool}")
  , ("<T: <T> {a: T, b: T}> {a: Int | T}", "{b: void, a: Int, a: Bool}")
  ]
