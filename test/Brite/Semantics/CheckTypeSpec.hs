...
testData =
  ...
  , ("<T: !, U: X> T", "<T: !, U: X> T", [])
  , ("<T: !, U = X> T", "<T: !, U = X> T", [])
  , ("<T: !, U: Nope> T", "<T: !, U: !> T", ["(0:10-0:14) Can not find `Nope`."])
  , ("<T: !, U = Nope> T", "<T: !, U = !> T", ["(0:11-0:15) Can not find `Nope`."])
  , ("<U: !, T: !> T", "<U: !, T: !> T", [])
  , ("<U: !, T: !> T", "<U: !, T: !> T", [])
  , ("<U = !, T: !> T", "<U = !, T: !> T", [])
  , ("<U: X, T: !> T", "<U: X, T: !> T", [])
  ...
  , ("fun(<T: !> T) -> Type1", "fun<Type1 = <T: !> T, Type2>(Type1) -> Type2", ["(0:17-0:22) Can not find `Type1`."])
