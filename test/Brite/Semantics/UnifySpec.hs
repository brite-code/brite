...
testData =
  ...
  -- , "unify(<F: fun<A>(<B, C: !> {a: A, b: B, c: C}) -> A, E: <B, A, C: !> {a: A, b: B, c: C}, T: !>, F, fun(E) -> T)"
  -- , "unify(<F: fun<A>(<B, C: !> {a: A, b: B, c: C}) -> A, E: <B, A, C: !> {a: A, b: B, c: C}, T: !>, fun(E) -> T, F)"
  -- , "unify(<F: fun<T, R>({val: T | R}) -> T, E: <A> {val: A, key: fun(A) -> Int}, Z: !>, F, fun(E) -> Z)"
  -- , "unify(<F: fun<T, R>({val: T | R}) -> T, E: <A> {val: A, key: fun(A) -> Int}, Z: !>, fun(E) -> Z, F)"
  -- , "unify(<F: fun<T, U, R>({val: T, key: U | R}) -> {fst: T, snd: U}, E: <A> {val: A, key: fun(A) -> Int}, Z: !>, F, fun(E) -> Z)"
  -- , "unify(<F: fun<T, U, R>({val: T, key: U | R}) -> {fst: T, snd: U}, E: <A> {val: A, key: fun(A) -> Int}, Z: !>, fun(E) -> Z, F)"
