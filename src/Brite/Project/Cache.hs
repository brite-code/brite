...
newtype SourceFileID = SourceFileID Int
...
updateSourceFile :: ProjectCache -> SourceFileID -> UTCTime -> IO ()
updateSourceFile (ProjectCache _ c) (SourceFileID i) newSourceTime =
