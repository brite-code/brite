    ...
    (if
     ...
     (block
      (call
       ...
       (int 47:17-47:18 4))))))
  (if (wrap 50:6-50:14 (new 50:7-50:13 (name 50:7-50:10 Foo))) block)
  (if
   (wrap
    51:6-51:19
    (add (new 51:7-51:13 (name 51:7-51:10 Foo)) (int 51:16-51:18 42)))
   block)
  (if
   (wrap
    52:6-52:19
    (add (int 52:7-52:9 42) (new 52:12-52:18 (name 52:12-52:15 Foo))))
   block)
  (if
   (add
    (wrap 53:6-53:14 (new 53:7-53:13 (name 53:7-53:10 Foo)))
    (int 53:17-53:19 42))
   block)
  (if
   (add
    (int 54:6-54:8 42)
    (wrap 54:11-54:19 (new 54:12-54:18 (name 54:12-54:15 Foo))))
   block)))
```
